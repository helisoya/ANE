...
void ANEShader::Shutdown()
{
	// Shutdown the vertex and pixel shaders as well as the related objects.
	ShutdownShader();
}

bool ANEShader::Render(ID3D11DeviceContext* deviceContext, int indexCount, XMMATRIX worldMatrix, XMMATRIX viewMatrix,
...
void ANEShader::RenderShader(ID3D11DeviceContext* deviceContext, int indexCount)
{
